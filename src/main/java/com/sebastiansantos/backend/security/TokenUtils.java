...
public class TokenUtils {
    ...
    private final static String ACCES_TOKEN_SECRET = "ON$pAgDRS!o3Qlvi7Ttl83jdeFpeCKX4#P3fO4eV";
    private final static Long ACCES_TOKEN_VALIDITY_SECONDS = 86400L;
    ...
    public static UsernamePasswordAuthenticationToken getAuthtntication(String token){
        try {
